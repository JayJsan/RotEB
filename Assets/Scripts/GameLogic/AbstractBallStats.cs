...
public abstract class AbstractBallStats : MonoBehaviour
{
    ...
    protected float m_currentMaxShootPower = 100f; // The maximum force the ball will can be shot with 
    ...
    protected float m_baseMaxShootPower {get; private set;} = 100f; // The maximum force the ball will can be shot with 
